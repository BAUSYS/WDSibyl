...
var
  VerticalMove, HorizontalMove: Integer;
begin
  HorizontalMove := NewPosition.X - Piece.SimplePiece.Position.X;
  VerticalMove := NewPosition.Y - Piece.SimplePiece.Position.Y;
  ...
  case Piece.SimplePiece.Name of
    ...
    Pawn:   begin
              if Piece.SimplePiece.Color = White then
