...
Procedure renderTeapot (x,y,ambr,ambg,ambb,difr,difg,difb,
...
Procedure myReshape(w,h:LongInt);
Begin
    glViewport(0, 0, w, h);
    glMatrixMode(GL_PROJECTION);
    glLoadIdentity;
    If w <= h Then glOrtho (0.0, 16.0, 0.0, 16.0*(h/w),-10.0, 10.0)
    Else glOrtho (0.0, 16.0*(w/h), 0.0, 16.0,-10.0, 10.0);
...
Begin
    auxInitDisplayMode (AUX_SINGLE Or AUX_RGB Or AUX_DEPTH);
