...
Const FS_CASE_SENSITIVE           = $0001; // Gross- und Kleinschreibung von Dateinamen wird bercksichtigt
      FS_CASE_IS_PRESERVED        = $0002; // Gross- und Kleinschreibung von Dateinamen wird erhalten.
      FS_UNICODE_ON_DISK          = $0004; // Unicode Dateinamen werden untersttzt.
      FS_PERSISTENT_ACLS          = $0008; // Accesslisten werden untersttzt / gefordert (z.B. bei Windows2000)
      FS_FILE_COMPRESSION         = $0010; // Untersttzt Dateikomprimierung.
      FS_VOL_IS_COMPRESSED        = $8000; // Komprimierter Datentrger.

// Konstanten fuer GetDriveType
Const DRIVE_UNKNOWN = 0;         // unbekannt
      DRIVE_NO_ROOT_DIR = 1;
      DRIVE_REMOVABLE = 2;       // Diskettenlaufwerk/Wechseldatentrger (z.B. auch ZIP)
