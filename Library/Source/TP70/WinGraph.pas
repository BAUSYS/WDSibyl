...
{ Fehlermeldungen }
const MaxColors       = 15;
      grOk            = 0;      { No error; Fehlerfreie Ausfhrung }
      grNoInitGraph   = -1;      { BGI graphics not installed; Grafiktreiber (.BGI) nicht geladen }
      grNotDetected   = -2;      { Graphics hardware not detected; Kein grafikfhiger Adapter vorhanden }
      ...
      grNoLoadMem     = -5;      { Not enough memory to load driver; Nicht genug Platz im Hauptspeicher fr den Grafiktreiber }
      ...
      grNoFontMem     = -8;      { Not enough memory to load font; Nicht genug Platz im Speicher fr die Schrift }
      grInvalidMode   = -9;      { Invalid graphics mode for selected driver; Grafikmodus wird vom Treiber nicht untersttzt }
      grError         =-10;      { Graphics error  (generic error); Nicht nher klassifizierbarer Fehler }
      grIOerror       =-11;      { Graphics I/O error; Ein-/Ausgabefehler beim Laden von Dateien }
      grInvalidFont   =-12;      { Invalid font file; Schrift-Datei ungltig }
      grInvalidFontNum=-13;      { Invalid font number; Kennziffer fr Zeichensatz nicht definiert }
...
{ M”gliche Grafikmodi der Treiber }
